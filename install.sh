#!/usr/bin/env sh
# Universal installer for gsafinder. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/gsafinder.git"
echo "Installing gsafinder ..."
